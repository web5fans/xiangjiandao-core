...
/// </summary>
[Tags("AdminApp")]
[HttpPost("/api/v1/admin/app/create")]
[Authorize(PolicyNames.Admin)]
public class CreateAppEndpoint(
    IMediator mediator
) : Endpoint<CreateAppReq, ResponseData<AppId>>
{
    public override async Task HandleAsync(CreateAppReq req, CancellationToken ct)
    {
...
public class CreateAppReq
{
    ...
    /// 请求转命令
    /// </summary>
    public CreateAppCommand ToCommand()
    {
...
/// 请求验证噐
/// </summary>
public class CreateAppReqValidator : AbstractValidator<CreateAppReq>
{
    public CreateAppReqValidator()
    {
        RuleFor(x => x.Name)
            .NotEmpty()
