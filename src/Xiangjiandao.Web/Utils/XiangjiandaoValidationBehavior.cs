...
public sealed class XiangjiandaoValidationBehavior<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
    where TRequest : class
{
    private readonly IEnumerable<IValidator<TRequest>> _validators;
    public XiangjiandaoValidationBehavior(IEnumerable<IValidator<TRequest>> validators) => _validators = validators;
